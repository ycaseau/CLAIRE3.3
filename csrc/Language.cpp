...
// definition of the properties 
  ...
  Core.self_eval->addMethod(list::domain(1,Kernel._unbound_symbol),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_unbound_symbol,"self_eval_unbound_symbol"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Variable),Kernel._void,
  	STRING_UPDATE,_function_(self_print_Variable_Language,"self_print_Variable_Language"));
  
  Language.ppvariable->addMethod(list::domain(1,Language._Variable),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(ppvariable_Variable,"ppvariable_Variable"));
  ...
  Language.write_value->addMethod(list::domain(2,Language._Variable,Kernel._any),Kernel._any,
  	STRING_UPDATE,_function_(write_value_Variable,"write_value_Variable"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Vardef),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Vardef,"self_eval_Vardef"));
  ...
  Language.write_value->addMethod(list::domain(2,Core._global_variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(write_value_global_variable,"write_value_global_variable"));
  ...
  Core.call->addMethod(list::domain(2,Core._lambda,Kernel._listargs),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(call_lambda2,"call_lambda2"));
  
  Kernel.self_print->addMethod(list::domain(1,Core._lambda),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_lambda_Language,"self_print_lambda_Language"));
  ...
  Language.lambda_I->addMethod(list::domain(2,Kernel._list,Kernel._any),Core._lambda,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(lambda_I_list,"lambda!_list"));
  
  Language.lexical_build->addMethod(list::domain(3,Kernel._any,Kernel._list,Kernel._integer),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(lexical_build_any,"lexical_build_any"));
  ...
  Language.make_a_property->addMethod(list::domain(1,Kernel._any),Kernel._property,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(make_a_property_any,"make_a_property_any"));
  ...
  Language.lbreak->addMethod(list::domain(1,Kernel._void),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(lbreak_void,"lbreak_void"));
  
  Language.put_buffer->addMethod(list::domain(1,Kernel._void),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(put_buffer_void,"put_buffer_void"));
  
  Language.checkfar->addMethod(list::domain(1,Kernel._void),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(checkfar_void,"checkfar_void"));
  
  Language.lbreak->addMethod(list::domain(1,Kernel._integer),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(lbreak_integer,"lbreak_integer"));
  
  Language.indent->addMethod(list::domain(1,Kernel._integer),Kernel._any,
  	STRING_UPDATE,_function_(indent_integer,"indent_integer"));
  
  Language.set_level->addMethod(list::domain(1,Kernel._void),Kernel._void,
  	SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(set_level_void,"set_level_void"));
  
  Language.set_level->addMethod(list::domain(1,Kernel._integer),Kernel._void,
  	SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(set_level_integer,"set_level_integer"));
  
  Language.printbox->addMethod(list::domain(4,Kernel._bag,
    Kernel._integer,
    Kernel._integer,
    Kernel._string),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(printbox_bag1,"printbox_bag1"));
  
  Language.printbox->addMethod(list::domain(1,Kernel._bag),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(printbox_bag2,"printbox_bag2"));
  
  Language.printbox->addMethod(list::domain(2,Kernel._bag,Kernel._string),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(printbox_bag3,"printbox_bag3"));
  
  Language.printl->addMethod(list::domain(2,Kernel._bag,Kernel._string),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(printl_bag,"printl_bag"));
  
  Language.printexp->addMethod(list::domain(2,Kernel._any,Kernel._boolean),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(printexp_any,"printexp_any"));
  
  Language.pretty_print->addMethod(list::domain(1,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(pretty_print_any,"pretty_print_any"));
  
  Kernel.self_print->addMethod(list::domain(1,Kernel._list),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_list_Language,"self_print_list_Language"));
  
  Kernel.self_print->addMethod(list::domain(1,Kernel._set),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_set_Language,"self_print_set_Language"));
  
  Kernel.self_print->addMethod(list::domain(1,Kernel._tuple),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_tuple_Language,"self_print_tuple_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Call),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Call_Language,"self_print_Call_Language"));
  
  Kernel.self_print->addMethod(list::domain(1,Language._Call_plus),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Call_plus_Language,"self_print_Call+_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Call,"self_eval_Call"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Call_plus),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Call_plus,"self_eval_Call+"));
  
  Language.printe->addMethod(list::domain(2,Kernel._any,Kernel._property),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(printe_any,"printe_any"));
  
  Language.sugar_ask->addMethod(list::domain(4,Kernel._any,
    Kernel._any,
    Kernel._any,
    Kernel._any),Kernel._boolean,
  	STRING_UPDATE,_function_(sugar_ask_any,"sugar?_any"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Assign),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Assign_Language,"self_print_Assign_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Assign),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Assign,"self_eval_Assign"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Gassign),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Gassign_Language,"self_print_Gassign_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Gassign),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Gassign,"self_eval_Gassign"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._And),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_And_Language,"self_print_And_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Or),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Or_Language,"self_print_Or_Language"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Call_method),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Call_method,"self_eval_Call_method"));
  ...
  { (Language._Call_method1 = ClaireClass::make("Call_method1",Language._Call_method,claire.it));
    Core.self_eval->addMethod(list::domain(1,Language._Call_method1),Kernel._any,
    	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Call_method1,"self_eval_Call_method1"));
    } 
  ...
  { (Language._Call_method2 = ClaireClass::make("Call_method2",Language._Call_method,claire.it));
    Core.self_eval->addMethod(list::domain(1,Language._Call_method2),Kernel._any,
    	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Call_method2,"self_eval_Call_method2"));
    } 
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Call_slot),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Call_slot,"self_eval_Call_slot"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Call_array),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Call_array,"self_eval_Call_array"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Call_table),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Call_table,"self_eval_Call_table"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Update),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Update,"self_eval_Update"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Super),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Super_Language,"self_print_Super_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Super),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Super,"self_eval_Super"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Cast),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Cast_Language,"self_print_Cast_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Cast),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Cast,"self_eval_Cast"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Return),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Return_Language,"self_print_Return_Language"));
  ...
  Language.substitution->addMethod(list::domain(3,Kernel._any,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(substitution_any,"substitution_any"));
  
  Language.occurrence->addMethod(list::domain(2,Kernel._any,Language._Variable),Kernel._integer,
  	NEW_ALLOC+STRING_UPDATE,_function_(occurrence_any,"occurrence_any"));
  
  Language.instruction_copy->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(instruction_copy_any,"instruction_copy_any"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._If),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_If_Language,"self_print_If_Language"));
  
  Language.printstat->addMethod(list::domain(1,Language._If),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(printstat_If,"printstat_If"));
  
  Language.printif->addMethod(list::domain(1,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(printif_any,"printif_any"));
  
  Language.printelse->addMethod(list::domain(1,Language._If),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(printelse_If,"printelse_If"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Do),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Do_Language,"self_print_Do_Language"));
  
  Language.printdo->addMethod(list::domain(2,Kernel._list,Kernel._boolean),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(printdo_list,"printdo_list"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Let),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Let_Language,"self_print_Let_Language"));
  
  Language.printbody->addMethod(list::domain(1,Language._Let),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(printbody_Let,"printbody_Let"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Let),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Let,"self_eval_Let"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._When),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_When_Language,"self_print_When_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._When),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_When,"self_eval_When"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Let_plus),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Let_plus_Language,"self_print_Let+_Language"));
  
  Kernel.self_print->addMethod(list::domain(1,Language._Let_star),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Let_star_Language,"self_print_Let*_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._For),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_For_Language,"self_print_For_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._For),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_eval_For,"self_eval_For"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Collect),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Collect_Language,"self_print_Collect_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Collect),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Collect,"self_eval_Collect"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Image),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Image_Language,"self_print_Image_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Image),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Image,"self_eval_Image"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Select),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Select_Language,"self_print_Select_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Select),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Select,"self_eval_Select"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Lselect),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Lselect_Language,"self_print_Lselect_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Lselect),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Lselect,"self_eval_Lselect"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Exists),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Exists_Language,"self_print_Exists_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Exists),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Exists,"self_eval_Exists"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Case),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Case_Language,"self_print_Case_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Case),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Case,"self_eval_Case"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._While),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_While_Language,"self_print_While_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Handle),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Handle_Language,"self_print_Handle_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Handle),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Handle,"self_eval_Handle"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Construct),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Construct_Language,"self_print_Construct_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._List),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_List,"self_eval_List"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Set),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Set,"self_eval_Set"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Array),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Array2,"self_eval_Array2"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Error),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Error,"self_eval_Error"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Printf),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Printf,"self_eval_Printf"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Trace),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Trace,"self_eval_Trace"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Assert),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Assert,"self_eval_Assert"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Branch),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(self_eval_Branch,"self_eval_Branch"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Definition),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Definition_Language,"self_print_Definition_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Defobj),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Defobj_Language,"self_print_Defobj_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Defclass),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Defclass_Language,"self_print_Defclass_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Defmethod),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Defmethod_Language,"self_print_Defmethod_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Defarray),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Defarray_Language,"self_print_Defarray_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Defrule),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_print_Defrule_Language,"self_print_Defrule_Language"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Language._Defvar),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(self_print_Defvar_Language,"self_print_Defvar_Language"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Definition),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Definition,"self_eval_Definition"));
  ...
  Language.complete->addMethod(list::domain(2,Kernel._object,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(complete_object,"complete_object"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Defobj),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(self_eval_Defobj,"self_eval_Defobj"));
  
  Core.self_eval->addMethod(list::domain(1,Language._Defclass),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Defclass,"self_eval_Defclass"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Defmethod),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+SAFE_RESULT+STRING_UPDATE,_function_(self_eval_Defmethod,"self_eval_Defmethod"));
  ...
  Language.attach_comment->addMethod(list::domain(1,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(attach_comment_any,"attach_comment_any"));
  
  Language.extract_signature->addMethod(list::domain(1,Kernel._list),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(extract_signature_list,"extract_signature_list"));
  
  Language.extract_pattern->addMethod(list::domain(2,Kernel._any,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(extract_pattern_any,"extract_pattern_any"));
  
  Language.extract_type->addMethod(list::domain(1,Kernel._any),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(extract_type_any,"extract_type_any"));
  
  Language.extract_item->addMethod(list::domain(2,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(extract_item_any,"extract_item_any"));
  
  Language.extract_pattern_nth->addMethod(list::domain(2,Kernel._list,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(extract_pattern_nth_list,"extract_pattern_nth_list"));
  
  Language.extract_class_call->addMethod(list::domain(2,Kernel._class,Kernel._list),Kernel._object,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(extract_class_call_class,"extract_class_call_class"));
  
  Language.extract_range->addMethod(list::domain(3,Kernel._any,Kernel._list,Kernel._list),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(extract_range_any,"extract_range_any"));
  ...
  { global_variable * _CL_obj = (Language._STRING_UPDATE = (global_variable *) Core._global_variable->instantiate("STRING_UPDATE",claire.it));
    (_CL_obj->range = Kernel.emptySet);
    (_CL_obj->value = 7);
    close_global_variable(_CL_obj);
    } 
  ...
  Language.extract_status->addMethod(list::domain(1,Kernel._any),Kernel._list,
  	NEW_ALLOC+STRING_UPDATE,_function_(extract_status_any,"extract_status_any"));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Defarray),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+SAFE_RESULT+STRING_UPDATE,_function_(self_eval_Defarray,"self_eval_Defarray"));
  
  { (Language._demon = ClaireClass::make("demon",Core._lambda,Language.it));
    CL_ADD_SLOT(Language._demon,Language_demon,Language.pname,pname,Kernel._symbol,_oid_(symbol_I_string2(copy_string("unamed"))));
  ...
  Core.self_eval->addMethod(list::domain(1,Language._Defrule),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_eval_Defrule,"self_eval_Defrule"));
  
  Language.eventMethod_ask->addMethod(list::domain(1,Kernel._relation),Kernel._boolean,
  	STRING_UPDATE,_function_(eventMethod_ask_relation2,"eventMethod?_relation2"));
  ...
  Language.make_filter->addFloatMethod(list::domain(1,Kernel._any),tuple::alloc(2,_oid_(Kernel._relation),GC_OID(_oid_(nth_class1(Kernel._list,Language._Variable)))),
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(make_filter_any,"make_filter_any"),_function_(make_filter_any_,"make_filter_any_"));
  ...
  Language.make_demon->addMethod(list::domain(5,Kernel._relation,
    ...
    Kernel._any),Language._demon,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(make_demon_relation,"make_demon_relation"));
  
  Language.readCall->addMethod(list::domain(2,Kernel._relation,Kernel._any),Language._Call,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(readCall_relation,"readCall_relation"));
  ...
  Language.safeRange->addMethod(list::domain(1,Kernel._relation),Kernel._type,
  	RETURN_ARG+STRING_UPDATE,_function_(safeRange_relation,"safeRange_relation"));
  
  Language.eval_if_write->addMethod(list::domain(1,Kernel._relation),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(eval_if_write_relation,"eval_if_write_relation"));
  
  Language.eventMethod->addMethod(list::domain(1,Kernel._property),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(eventMethod_property,"eventMethod_property"));
  ...
  Language.ClaireInterface->addMethod(list::domain(1,Kernel._property),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(interface_property,"interface_property"));
  
  Language.ClaireInterface->addMethod(list::domain(2,Kernel._class,Kernel._listargs),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+STRING_UPDATE,_function_(interface_class,"interface_class"));
