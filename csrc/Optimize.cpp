...
// definition of the properties 
  ...
  Optimize.use_string_update = property::make("use_string_update",2,Compile.it);
  ...
  { (Optimize._meta_OPT = ClaireClass::make("meta_OPT",Kernel._thing,Optimize.it));
    ...
    CL_ADD_SLOT(Optimize._meta_OPT,Optimize_meta_OPT,Optimize.use_string_update,use_string_update,Kernel._boolean,Kernel.cfalse);
    } 
  ...
  { (Optimize._meta_compiler = ClaireClass::make("meta_compiler",Kernel._thing,Optimize.it));
    ...
    CL_ADD_SLOT(Optimize._meta_compiler,Optimize_meta_compiler,Optimize.env,env,Kernel._string,_string_(copy_string("ntw")));
  ...
  { global_variable * v2072 = (Optimize.claire_modules = (global_variable *) Core._global_variable->instantiate("claire_modules",claire.it));
    ...
    { global_variable * v11493 = v2072; 
      OID  v11494;
      { list * v13122;{ bag *v_list; OID v_val;
          OID v6224,CLcount;
          v_list = list::alloc(4,_string_(copy_string("Kernel")),
            _string_(copy_string("Core")),
            _string_(copy_string("Language")),
            _string_(copy_string("Reader")));
           v13122 = v_list->clone();
          for (CLcount= 1; CLcount <= v_list->length; CLcount++)
          { v6224 = (*(v_list))[CLcount];
            v_val = value_string(string_v(v6224));
  ...
  { (Optimize.compiler = (Optimize_meta_compiler *) Optimize._meta_compiler->instantiate("compiler",claire.it));
    (Optimize.compiler->external = copy_string("MS VC++"));
    (Optimize.compiler->env = copy_string("ntv"));
    (Optimize.compiler->version = _float_(3.46));
    (Optimize.compiler->source = copy_string(""));
    (Optimize.compiler->headers_dir = copy_string(""));
    (Optimize.compiler->libraries = list::alloc(Kernel._string,1,_string_(copy_string("Kernel"))));
  ...
  Optimize.c_type->addMethod(list::domain(1,Kernel._any),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_any_Optimize,"c_type_any_Optimize"));
  
  Optimize.c_strict_code->addMethod(list::domain(2,Kernel._any,Kernel._class),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_strict_code_any,"c_strict_code_any"));
  
  Optimize.c_strict_check->addMethod(list::domain(2,Kernel._any,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_strict_check_any_Optimize,"c_strict_check_any_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Kernel._any,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_any1_Optimize,"c_code_any1_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_any2_Optimize,"c_code_any2_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_any,"c_gc?_any"));
  
  Optimize.c_sort->addMethod(list::domain(1,Kernel._any),Kernel._class,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_sort_any_Optimize,"c_sort_any_Optimize"));
  
  Optimize.selector_psort->addMethod(list::domain(1,Language._Call),Kernel._class,
  	RETURN_ARG+STRING_UPDATE,_function_(selector_psort_Call,"selector_psort_Call"));
  
  Optimize.c_status->addMethod(list::domain(2,Kernel._any,Kernel._list),Kernel._integer,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_status_any,"c_status_any"));
  
  Optimize.c_or->addMethod(list::domain(2,Kernel._integer,Kernel._integer),Kernel._integer,
  	STRING_UPDATE,_function_(c_or_integer,"c_or_integer"));
  
  Optimize.c_or->addMethod(list::domain(1,Kernel._list),Kernel._integer,
  	STRING_UPDATE,_function_(c_or_list,"c_or_list"))->inlineDef("lambda[(l:list),let d := 0 in (for x in l d := c_or(d, x), d)]");
  
  Optimize.status_I->addMethod(list::domain(1,Kernel._restriction),Kernel._integer,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(status_I_restriction,"status!_restriction"));
  
  Optimize.c_return->addMethod(list::domain(2,Kernel._integer,Kernel._integer),Kernel._integer,
  	STRING_UPDATE,_function_(c_return_integer,"c_return_integer"));
  
  Optimize.c_status->addMethod(list::domain(1,Kernel._property),Kernel._integer,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_status_property,"c_status_property"));
  ...
  { (CLREAD(method,_at_property1(Core.vmatch_ask,Kernel._any),status) = 32);
    ...
    (CLREAD(method,_at_property1(Kernel.nth_equal,Kernel._string),status) = 128);
    (CLREAD(method,_at_property1(Kernel.nth_put,Kernel._string),status) = 128);
    } 
  
  Optimize.showstatus->addMethod(list::domain(1,Kernel._method),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(showstatus_method2,"showstatus_method2"));
  
  Optimize.s_test->addMethod(list::domain(1,Kernel._method),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(s_test_method2,"s_test_method2"));
  
  Optimize.legal_ask->addMethod(list::domain(2,Kernel._module,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(legal_ask_module,"legal?_module"));
  ...
  Optimize.c_register->addMethod(list::domain(1,U_type(Kernel._thing,Kernel._class)),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_register_object,"c_register_object"));
  
  Optimize.c_register->addMethod(list::domain(1,Kernel._property),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(c_register_property,"c_register_property"));
  
  Optimize.selector_register->addMethod(list::domain(1,Kernel._property),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+SAFE_RESULT+STRING_UPDATE,_function_(selector_register_property,"selector_register_property"));
  
  Optimize.allocate_ask->addMethod(list::domain(1,Kernel._property),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(allocate_ask_property,"allocate?_property"));
  
  Optimize.stable_ask->addMethod(list::domain(1,Kernel._relation),Kernel._boolean,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(stable_ask_relation,"stable?_relation"));
  ...
  Reader.known_I->addMethod(list::domain(1,Kernel._listargs),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(known_I_listargs,"known!_listargs"));
  
  Optimize.oload->addMethod(list::domain(1,Kernel._module),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(oload_module,"oload_module"));
  
  Optimize.oload->addMethod(list::domain(1,Kernel._string),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(oload_string,"oload_string"));
  
  Optimize.turbo->addMethod(list::domain(1,Kernel._module),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(turbo_module,"turbo_module"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Optimize._to_CL),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_to_CL_Optimize,"c_type_to_CL_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Optimize._to_CL),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_gc_ask_to_CL,"c_gc?_to_CL"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Optimize._to_C),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_gc_ask_to_C,"c_gc?_to_C"));
  
  Optimize.c_type->addMethod(list::domain(1,Optimize._to_C),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_to_C_Optimize,"c_type_to_C_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Optimize._C_cast),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_C_cast,"c_gc?_C_cast"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Optimize._C_cast,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_C_cast_Optimize,"c_code_C_cast_Optimize"));
  ...
  Kernel._Z->addMethod(list::domain(2,Kernel._any,Optimize._Pattern),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(_Z_any3,"%_any3"));
  ...
  Core.less_ask->addMethod(list::domain(2,Optimize._Pattern,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(less_ask_Pattern,"less?_Pattern"));
  
  Core.less_ask->addMethod(list::domain(2,Kernel._any,Optimize._Pattern),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(less_ask_any,"less?_any"));
  ...
  Optimize.warn->addMethod(list::domain(1,Kernel._void),Kernel._void,
  	NEW_ALLOC+STRING_UPDATE,_function_(warn_void,"warn_void"));
  ...
  Optimize.notice->addMethod(list::domain(1,Kernel._void),Kernel._void,
  	STRING_UPDATE,_function_(notice_void,"notice_void"));
  
  Optimize.c_warn->addMethod(list::domain(2,Language._Call,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_warn_Call,"c_warn_Call"));
  
  Optimize.c_warn->addMethod(list::domain(2,Language._Super,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_warn_Super,"c_warn_Super"));
  
  Optimize.c_warn->addMethod(list::domain(3,Kernel._property,Kernel._list,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_warn_property,"c_warn_property"));
  
  Optimize.c_warn->addMethod(list::domain(3,Language._Variable,Kernel._any,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_warn_Variable,"c_warn_Variable"));
  
  Optimize.sort_equal->addMethod(list::domain(2,Kernel._class,Kernel._class),Kernel._any,
  	STRING_UPDATE,_function_(sort_equal_class,"sort=_class"));
  
  Optimize.psort->addMethod(list::domain(1,Kernel._any),Kernel._class,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(psort_any,"psort_any"));
  
  Optimize.osort->addMethod(list::domain(1,Kernel._any),Kernel._class,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(osort_any,"osort_any"));
  
  Core.sort->addMethod(list::domain(1,Language._Variable),Kernel._class,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(sort_Variable,"sort_Variable"));
  
  Optimize.stupid_t->addMethod(list::domain(1,Kernel._any),Kernel._class,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(stupid_t_any1,"stupid_t_any1"));
  
  Optimize.stupid_t->addMethod(list::domain(2,Kernel._any,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(stupid_t_any2,"stupid_t_any2"));
  
  Optimize.extended_ask->addMethod(list::domain(1,Kernel._type),Kernel._boolean,
  	STRING_UPDATE,_function_(extended_ask_type,"extended?_type"));
  ...
  Optimize.pmember->addMethod(list::domain(1,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(pmember_type,"pmember_type"));
  
  Optimize.enumerate_code->addMethod(list::domain(2,Kernel._any,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(enumerate_code_any,"enumerate_code_any"));
  
  Optimize.range_infers_for->addMethod(list::domain(3,Language._Variable,Kernel._type,Kernel._type),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(range_infers_for_Variable,"range_infers_for_Variable"));
  
  Optimize.range_infers->addMethod(list::domain(2,Language._Variable,Kernel._type),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(range_infers_Variable,"range_infers_Variable"));
  
  Optimize.range_infer_case->addMethod(list::domain(2,Kernel._any,Kernel._type),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(range_infer_case_any,"range_infer_case_any"));
  
  Optimize.c_check->addMethod(list::domain(2,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_check_any,"c_check_any"));
  
  Optimize.range_sets->addMethod(list::domain(2,Kernel._any,Kernel._type),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(range_sets_any,"range_sets_any"));
  
  Optimize.c_srange->addMethod(list::domain(1,Kernel._method),Kernel._class,
  	RETURN_ARG+STRING_UPDATE,_function_(c_srange_method,"c_srange_method"));
  
  Optimize.nativeVar_ask->addMethod(list::domain(1,Core._global_variable),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(nativeVar_ask_global_variable,"nativeVar?_global_variable"));
  
  Optimize.return_type->addMethod(list::domain(1,Kernel._any),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(return_type_any,"return_type_any"));
  
  Optimize.c_code->addMethod(list::domain(2,Core._Type,Kernel._class),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_code_Type_Optimize,"c_code_Type_Optimize"));
  ...
  Optimize.self_code->addMethod(list::domain(1,Core._Param),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(self_code_Param,"self_code_Param"));
  ...
  Optimize.member_code->addMethod(list::domain(2,Kernel._class,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(member_code_class2,"member_code_class2"));
  ...
  Optimize.member_code->addMethod(list::domain(2,Core._Interval,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(member_code_Interval,"member_code_Interval"));
  
  Optimize.member_code->addMethod(list::domain(2,Core._Param,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(member_code_Param,"member_code_Param"));
  
  Optimize.member_code->addMethod(list::domain(2,Kernel._tuple,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(member_code_tuple,"member_code_tuple"));
  
  Optimize.member_code->addMethod(list::domain(2,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(member_code_any,"member_code_any"));
  ...
  Kernel._Z->addMethod(list::domain(2,Kernel._any,nth_property(Kernel._dot_dot,tuple::alloc(2,_oid_(Kernel._any),_oid_(Kernel._any)))),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(_Z_any4,"%_any4"))->inlineDef("lambda[(x:any,y:..[tuple(any,any)]),(x <= eval(y.args[2]) & eval(y.args[1]) <= x)]");
  ...
  Kernel._Z->addMethod(list::domain(2,Kernel._any,nth_property(Core.but,tuple::alloc(2,_oid_(Kernel._any),_oid_(Kernel._any)))),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(_Z_any5,"%_any5"))->inlineDef("lambda[(x:any,y:but[tuple(any,any)]),(x % eval(y.args[1]) & x != eval(y.args[2]))]");
  
  Optimize.gcsafe_ask->addMethod(list::domain(1,Kernel._class),Kernel._boolean,
  	STRING_UPDATE,_function_(gcsafe_ask_class,"gcsafe?_class"));
  
  Optimize.gcsafe_ask->addMethod(list::domain(1,Kernel._type),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(gcsafe_ask_type,"gcsafe?_type"));
  
  Optimize.gcsafe_ask->addMethod(list::domain(1,Kernel._property),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(gcsafe_ask_property,"gcsafe?_property"));
  
  Optimize.c_gc_I->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_gc_I_any1,"c_gc!_any1"));
  
  Optimize.c_gc_I->addMethod(list::domain(2,Kernel._any,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_gc_I_any2,"c_gc!_any2"));
  
  Optimize.need_protect->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(need_protect_any,"need_protect_any"));
  ...
  Optimize.designated_ask->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(designated_ask_any,"designated?_any"));
  
  Optimize.gc_register->addMethod(list::domain(1,Language._Variable),Kernel._any,
  	SLOT_UPDATE+STRING_UPDATE,_function_(gc_register_Variable,"gc_register_Variable"));
  
  Optimize.gc_register->addMethod(list::domain(2,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(gc_register_Variable2,"gc_register_Variable2"));
  
  Optimize.inner2outer_ask->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(inner2outer_ask_any,"inner2outer?_any"));
  
  Optimize.identifiable_ask->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(identifiable_ask_any,"identifiable?_any"));
  
  Optimize.c_inline->addMethod(list::domain(3,Kernel._method,Kernel._list,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_inline_method1,"c_inline_method1"));
  
  Optimize.c_inline->addMethod(list::domain(2,Kernel._method,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_inline_method2,"c_inline_method2"));
  
  Optimize.c_inline_arg_ask->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_inline_arg_ask_any,"c_inline_arg?_any"));
  ...
  Optimize.c_substitution->addMethod(list::domain(4,Kernel._any,
    ...
    Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_substitution_any,"c_substitution_any"));
  ...
  Optimize.bound_variables->addMethod(list::domain(1,Kernel._any),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(bound_variables_any,"bound_variables_any"));
  
  Optimize.c_boolean->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_boolean_any,"c_boolean_any"));
  ...
  Optimize.restriction_I->addMethod(list::domain(3,Kernel._property,Kernel._list,Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(restriction_I_property,"restriction!_property"));
  
  Optimize.restriction_I->addMethod(list::domain(3,Kernel._list,Kernel._list,Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(restriction_I_list,"restriction!_list"));
  
  Optimize.restriction_I->addMethod(list::domain(3,Kernel._class,Kernel._list,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(restriction_I_class,"restriction!_class"));
  
  Optimize.use_range->addMethod(list::domain(2,Kernel._method,Kernel._list),Kernel._type,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(use_range_method,"use_range_method"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Call),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Call_Optimize,"c_type_Call_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Call_Optimize,"c_code_Call_Optimize"));
  
  Optimize.c_code_call->addMethod(list::domain(2,Language._Call,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_call_Call,"c_code_call_Call"));
  
  Optimize.open_message->addMethod(list::domain(2,Kernel._property,Kernel._list),Language._Call,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(open_message_property,"open_message_property"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Call),Kernel._boolean,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(c_gc_ask_Call,"c_gc?_Call"));
  
  Optimize.daccess->addMethod(list::domain(2,Kernel._any,Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(daccess_any,"daccess_any"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Call_slot),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_Call_slot,"c_gc?_Call_slot"));
  ...
  Optimize.c_code_write->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_write_Call,"c_code_write_Call"));
  
  Optimize.c_code_hold->addMethod(list::domain(4,Kernel._property,
    Kernel._any,
    Kernel._any,
    Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_hold_property,"c_code_hold_property"));
  
  Optimize.c_code_add->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_add_Call,"c_code_add_Call"));
  
  Optimize.c_code_add_bag->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_add_bag_Call,"c_code_add_bag_Call"));
  
  Optimize.c_code_delete->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_delete_Call,"c_code_delete_Call"));
  
  Optimize.c_code_not->addMethod(list::domain(1,Language._Select),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_not_Select,"c_code_not_Select"));
  
  Optimize.c_code_belong->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_belong_Call,"c_code_belong_Call"));
  
  Optimize.c_code_nth->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_nth_Call,"c_code_nth_Call"));
  
  Optimize.c_code_table->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_table_Call,"c_code_table_Call"));
  
  Optimize.c_code_array->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_array_Call,"c_code_array_Call"));
  
  Optimize.Update_ask->addMethod(list::domain(3,Kernel._relation,Kernel._any,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(Update_ask_relation,"Update?_relation"));
  
  Optimize.Update_ask->addMethod(list::domain(2,Kernel._relation,Kernel._relation),Kernel._boolean,
  	STRING_UPDATE,_function_(Update_ask_relation2,"Update?_relation2"));
  ...
  Optimize.c_code_method->addMethod(list::domain(3,Kernel._method,Kernel._list,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_method_method1,"c_code_method_method1"));
  
  Optimize.c_code_method->addMethod(list::domain(4,Kernel._method,
    Kernel._list,
    Kernel._list,
    Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_method_method2,"c_code_method_method2"));
  
  Optimize.Call_method_I->addMethod(list::domain(2,Kernel._method,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(Call_method_I_method,"Call_method!_method"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Call_method),Kernel._type,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(c_type_Call_method_Optimize,"c_type_Call_method_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Call_method),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_gc_ask_Call_method,"c_gc?_Call_method"));
  ...
  Optimize.functional_I->addMethod(list::domain(1,Kernel._method),Kernel._function,
  	NEW_ALLOC+STRING_UPDATE,_function_(functional_I_method_Optimize,"functional!_method_Optimize"));
  
  Optimize.nth_type_check->addMethod(list::domain(3,Kernel._type,Kernel._type,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(nth_type_check_type,"nth_type_check_type"))->inlineDef("lambda[(tl:type,ti:type,tx:type),(if not(tx <= member(tl)) (Compile/warn(), trace(2, \"unsafe update on bag: type ~S into ~S [252]\\n\", tx, tl)) else false, tx)]");
  ...
  Optimize.c_inline_ask->addMethod(list::domain(2,Kernel._method,Kernel._list),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_inline_ask_method,"c_inline?_method"));
  
  Optimize.inline_optimize_ask->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(inline_optimize_ask_Call,"inline_optimize?_Call"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Assign),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_Assign_Optimize,"c_type_Assign_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Assign),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Assign_Optimize,"c_code_Assign_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Assign),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_Assign,"c_gc?_Assign"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Gassign),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_Gassign_Optimize,"c_type_Gassign_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Gassign),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Gassign_Optimize,"c_code_Gassign_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Gassign),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_Gassign,"c_gc?_Gassign"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Optimize._to_protect),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_to_protect_Optimize,"c_type_to_protect_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Return),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Return_Optimize,"c_code_Return_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Handle),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Handle_Optimize,"c_type_Handle_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Handle,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Handle_Optimize,"c_code_Handle_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Handle),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_Handle,"c_gc?_Handle"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Cast),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Cast_Optimize,"c_code_Cast_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Super),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Super_Optimize,"c_type_Super_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Super),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Super_Optimize,"c_code_Super_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Assert),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Assert_Optimize,"c_code_Assert_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Trace),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Trace_Optimize,"c_code_Trace_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Branch),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Branch_Optimize,"c_code_Branch_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Macro,Kernel._class),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_code_Macro_Optimize,"c_code_Macro_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Macro),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_Macro_Optimize,"c_type_Macro_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Printf),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Printf_Optimize,"c_code_Printf_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Error),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Error_Optimize,"c_code_Error_Optimize"));
  
  Optimize.extendedTest_ask->addMethod(list::domain(1,Language._If),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(extendedTest_ask_If,"extendedTest?_If"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._If),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_type_If_Optimize,"c_type_If_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Language._If,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_If_Optimize,"c_code_If_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._If),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_If,"c_gc?_If"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Case),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_type_Case_Optimize,"c_type_Case_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Case,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Case_Optimize,"c_code_Case_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Do),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_Do_Optimize,"c_type_Do_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Do),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_Do,"c_gc?_Do"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Let),Kernel._type,
  	NEW_ALLOC+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Let_Optimize,"c_type_Let_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Let,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Let_Optimize,"c_code_Let_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._When),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_When_Optimize,"c_type_When_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._When,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_When_Optimize,"c_code_When_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Let),Kernel._boolean,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_gc_ask_Let,"c_gc?_Let"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._For),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_For_Optimize,"c_type_For_Optimize"));
  
  Optimize.infers_from->addMethod(list::domain(2,Kernel._type,Kernel._any),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(infers_from_type2,"infers_from_type2"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._For,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_For_Optimize,"c_code_For_Optimize"));
  
  Optimize.c_code_multiple->addMethod(list::domain(3,Language._For,Kernel._type,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_multiple_For,"c_code_multiple_For"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Iteration),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Iteration_Optimize,"c_type_Iteration_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Iteration),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Iteration_Optimize,"c_code_Iteration_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Select),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Select_Optimize,"c_code_Select_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Lselect),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Lselect_Optimize,"c_code_Lselect_Optimize"));
  
  Optimize.c_code_select->addMethod(list::domain(2,Language._Iteration,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_select_Iteration,"c_code_select_Iteration"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Exists),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_type_Exists_Optimize,"c_type_Exists_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Exists,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Exists_Optimize,"c_code_Exists_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Image),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Image_Optimize,"c_type_Image_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Select),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Select_Optimize,"c_type_Select_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Lselect),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Lselect_Optimize,"c_type_Lselect_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._While),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_While_Optimize,"c_type_While_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._While,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_While_Optimize,"c_code_While_Optimize"));
  
  Optimize.Iterate_I->addMethod(list::domain(1,Language._Iteration),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(Iterate_I_Iteration,"Iterate!_Iteration"));
  ...
  Language.iterate->addMethod(list::domain(3,Core._Interval,nth_class2(Language._Variable,GC_OBJECT(list,list::alloc(Kernel._any,1,_oid_(Kernel.range))),GC_OBJECT(list,list::alloc(Kernel.emptySet,1,GC_OID(_oid_(nth_class1(Kernel._type,Kernel._integer)))))),Kernel._any),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(iterate_Interval,"iterate_Interval"))->inlineDef("lambda[(x:Interval,v:Variable[range:(subtype[integer])],e:any),let v := eval(x.arg1, Interval),%max:integer := eval(x.arg2, Interval) in while (v <= %max) (e, v := v + 1)]");
  
  Language.iterate->addMethod(list::domain(3,Kernel._array,Language._Variable,Kernel._any),Kernel._any,
  	STRING_UPDATE,_function_(iterate_array,"iterate_array"))->inlineDef("lambda[(x:array,v:Variable,e:any),let %i := 1,%a := x,%max := length(%a) in while (%i <= %max) let v := %a[%i] in (e, %i := %i + 1)]");
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Kernel._dot_dot,tuple::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer))),Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+STRING_UPDATE,_function_(Iterate_any1,"Iterate_any1"))->inlineDef("lambda[(x:..[tuple(integer,integer)],v:Variable,e:any),let v := eval(x.args[1]),%max := eval(x.args[2]) in while (v <= %max) (e, v := v + 1)]");
  
  Language.Iterate->addMethod(list::domain(3,Language._Lselect,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Iterate_Lselect,"Iterate_Lselect"))->inlineDef("lambda[(x:Lselect,v:Variable,e:any),for v in eval(x.iClaire/set_arg) (if eval(substitution(x.arg, x.var, v)) e else false)]");
  
  Language.Iterate->addMethod(list::domain(3,Language._Select,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Iterate_Select,"Iterate_Select"))->inlineDef("lambda[(x:Select,v:Variable,e:any),for v in eval(x.iClaire/set_arg) (if eval(substitution(x.arg, x.var, v)) e else false)]");
  
  Language.Iterate->addMethod(list::domain(3,Language._Collect,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Iterate_Collect,"Iterate_Collect"))->inlineDef("lambda[(x:Collect,v:Variable,e:any),for C%v in eval(x.iClaire/set_arg) let v := eval(substitution(x.arg, x.var, C%v)) in e]");
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Core.but,tuple::alloc(2,_oid_(Kernel._any),_oid_(Kernel._any))),Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(Iterate_any2,"Iterate_any2"))->inlineDef("lambda[(x:but[tuple(any,any)],v:Variable,e:any),for v in eval(x.args[1]) (if (v != eval(x.args[2])) e else false)]");
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Kernel._7_plus,tuple::alloc(2,_oid_(Kernel._any),_oid_(Kernel._any))),Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(Iterate_any3,"Iterate_any3"))->inlineDef("lambda[(x:/+[tuple(any,any)],v:Variable,e:any),(for v in eval(x.args[1]) e, for v in eval(x.args[2]) e)]");
  
  Optimize.c_type->addMethod(list::domain(1,Language._List),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_List_Optimize,"c_type_List_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._List),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_List_Optimize,"c_code_List_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Set),Kernel._type,
  	NEW_ALLOC+RETURN_ARG+STRING_UPDATE,_function_(c_type_Set_Optimize,"c_type_Set_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Set),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Set_Optimize,"c_code_Set_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Tuple),Kernel._type,
  	NEW_ALLOC+STRING_UPDATE,_function_(c_type_Tuple_Optimize,"c_type_Tuple_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Tuple),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Tuple_Optimize,"c_code_Tuple_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Definition),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_type_Definition_Optimize,"c_type_Definition_Optimize"));
  ...
  { global_variable * v2072 = (Optimize._starname_star = (global_variable *) Core._global_variable->instantiate("*name*",Compile.it));
    ...
    (v2072->value = _oid_(symbol_I_string2(copy_string("_CL_obj"))));
    close_global_variable(v2072);
    } 
  
  Optimize.c_code->addMethod(list::domain(2,Language._Definition,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Definition_Optimize,"c_code_Definition_Optimize"));
  
  Optimize.total_ask->addMethod(list::domain(2,Kernel._class,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(total_ask_class,"total?_class"));
  
  Optimize.analyze_I->addMethod(list::domain(4,Kernel._class,
    Kernel._any,
    Kernel._list,
    Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(analyze_I_class,"analyze!_class"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Defobj,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(c_code_Defobj_Optimize,"c_code_Defobj_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Defclass,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Defclass_Optimize,"c_code_Defclass_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Defmethod),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Defmethod_Optimize,"c_code_Defmethod_Optimize"));
  
  Optimize.sort_pattern_ask->addMethod(list::domain(2,Kernel._list,Kernel._any),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(sort_pattern_ask_list,"sort_pattern?_list"));
  
  Optimize.sort_code->addMethod(list::domain(2,Language._Defmethod,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(sort_code_Defmethod,"sort_code_Defmethod"));
  ...
  Optimize.add_method_I->addMethod(list::domain(5,Kernel._method,
    ...
    Kernel._function),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(add_method_I_method,"add_method!_method"));
  
  Optimize.extract_status_new->addMethod(list::domain(1,Kernel._any),Kernel._list,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(extract_status_new_any,"extract_status_new_any"));
  
  Optimize.extract_signature_I->addMethod(list::domain(1,Kernel._list),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(extract_signature_I_list,"extract_signature!_list"));
  ...
  Optimize._equalsig_ask->addMethod(list::domain(2,Kernel._list,Kernel._list),Kernel._boolean,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(_equalsig_ask_list,"=sig?_list"));
  ...
  Optimize.function_name->addMethod(list::domain(3,Kernel._property,Kernel._list,Kernel._any),Kernel._string,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(function_name_property_Optimize,"function_name_property_Optimize"));
  
  Optimize.compile_lambda->addMethod(list::domain(3,Kernel._string,Core._lambda,Kernel._any),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE+STRING_UPDATE,_function_(compile_lambda_string,"compile_lambda_string"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Defarray),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Defarray_Optimize,"c_code_Defarray_Optimize"));
  
  Optimize.compute_if_write_inverse->addMethod(list::domain(1,Kernel._relation),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(compute_if_write_inverse_relation2,"compute_if_write_inverse_relation2"));
  
  Optimize.compute_set_write->addMethod(list::domain(1,Kernel._relation),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(compute_set_write_relation2,"compute_set_write_relation2"));
  
  Optimize.Produce_put->addMethod(list::domain(3,Kernel._property,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Produce_put_property2,"Produce_put_property2"));
  
  Optimize.Produce_erase->addMethod(list::domain(2,Kernel._property,Language._Variable),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Produce_erase_property2,"Produce_erase_property2"));
  ...
  Optimize.Produce_get->addMethod(list::domain(2,Kernel._relation,Language._Variable),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Produce_get_relation2,"Produce_get_relation2"));
  
  Optimize.Produce_remove->addMethod(list::domain(3,Kernel._property,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(Produce_remove_property2,"Produce_remove_property2"));
  ...
  Optimize.Tighten->addMethod(list::domain(1,Kernel._relation),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(Tighten_relation2,"Tighten_relation2"));
  
  Optimize.lexical_num->addMethod(list::domain(2,Kernel._any,Kernel._integer),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(lexical_num_any2,"lexical_num_any2"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Language._Defrule,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(c_code_Defrule_Optimize,"c_code_Defrule_Optimize"));
  
  Optimize.compile_if_write->addMethod(list::domain(1,Kernel._relation),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+RETURN_ARG+STRING_UPDATE,_function_(compile_if_write_relation,"compile_if_write_relation"));
  
  Optimize.compileEventMethod->addMethod(list::domain(1,Kernel._property),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE+STRING_UPDATE,_function_(compileEventMethod_property,"compileEventMethod_property"));
