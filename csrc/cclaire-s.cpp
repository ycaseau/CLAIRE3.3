// --- System configuration file for "cclaire" , ["Sat Jan 28 08:49:59 2006\n"] ---
...
{ //module definitions 
  ...
  "d:\\claire\\v3.3\\src\\meta",list::alloc(Kernel.emptySet,4,_string_("method"),
    _string_("object"),
    _string_("function"),
    _string_("types")));
  ...
  "d:\\claire\\v3.3\\src\\meta",list::alloc(Kernel.emptySet,4,_string_("pretty"),
    _string_("call"),
    _string_("control"),
    _string_("define")));
  Reader.initModule("Reader",iClaire.it,list::alloc(Kernel.emptySet,3,_oid_(Kernel.it),
    _oid_(Core.it),
    _oid_(Language.it)),
  "d:\\claire\\v3.3\\src\\meta",list::alloc(Kernel.emptySet,4,_string_("read"),
    _string_("syntax"),
    _string_("file"),
    _string_("inspect")));
  ...
  "d:\\claire\\v3.3\\src\\compile",list::alloc(Kernel._string,5,_string_("osystem"),
    _string_("otool"),
    _string_("ocall"),
    _string_("ocontrol"),
    _string_("odefine")));
  Generate.initModule("Generate",Compile.it,list::alloc(Kernel._module,2,_oid_(Optimize.it),_oid_(mClaire.it)),
  "d:\\claire\\v3.3\\src\\compile",list::alloc(Kernel._string,5,_string_("gsystem"),
    _string_("gexp"),
    _string_("gstat"),
    _string_("cgen"),
    _string_("copt")));
