...
// recommendation
about() : any
 -> (printf("CLAIRE v3.~A Copyright (C) 1994-2003 Yves Caseau. All Rights Reserved.\n",
            version()),
     printf("use in binary forms is permitted\n"),
     printf("redistribution or resale in any form are not permitted without the\n"),
     printf("explicit agreement of Yves Caseau\n"),
